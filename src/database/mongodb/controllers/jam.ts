...
export class CodeJamCommandController {
	private instance: Main;
	// Cache of all tags mapped by guildId
	public cache: Collection<string, CodeJamSchema>;
	...
	public constructor(i: Main) {
		...
		this.query = this.instance.database.schemas.jam;
	 ...
	 * @returns
	 */
	public async getCodeJam(guildId: string): Promise<CodeJamSchema | null> {
